...
# Leave empty to skip.
EVAL_DATASET=${BASEDIR}/vstar_code_v1.parquet

REF_MODEL_PATH=Qwen/Qwen2.5-VL-7B-Instruct
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    +debug=False \
    +vs_debug=False \
    data.train_files=[${VISUAL_DATASET_TRAIN_ALL}] \
    ...
    actor_rollout_ref.rollout.agent.aux_img_dir="/workspace/shared/datasets/CodeV_images/" \
    ...
    custom_reward_function.name=_batched_compute_score \
    +reward_model.reward_kwargs.num_workers=50 2>&1 | tee ./logs/${EXPERIMENT_NAME}.log
