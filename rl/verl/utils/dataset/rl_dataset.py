    ...
    def __getitem__(self, item):
        ...
        if self.processor is not None:
            ...
            if self.image_key in row_dict:
                image_data = row_dict.pop(self.image_key)
                
                # Handle two different image formats:
                if isinstance(image_data, bytes):
                    # New format: raw bytes directly
                    image_list = [image_data]
                else:
                    # Old format: numpy array or list containing image dicts
                    image_list = image_data
                
                origin_images = [process_raw_image(image) for image in image_list]
        ...
        # Preserve extra_info for downstream usage (e.g., tool reset)
